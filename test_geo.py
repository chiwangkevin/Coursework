...
def test_great_circle_distance():
    '''
    test the calculation of haversine function
    '''
    assert round(great_circle_distance((0.1,0.2),(0.5, 0.6)),1)==62.9

def test_station_by_distance():#
    '''
    tests functionality of station_by_distance() function
    '''
...
def test_stations_within_radius():
    '''
    tests functionality of test_stations_within_radius()
    '''
    stations = build_station_list()
...
def test_rivers_with_station():
    '''
    tests functionality of test_rivers_with_station()
    '''
    stations = build_station_list()
...
def test_stations_by_river():
    '''
    Test the functionality of test_stations_by_river()
    '''
    stations = build_station_list()
...
def test_rivers_by_station_number():
    '''
    Test the functionality of test_rivers_by_station_number()
    '''
    stations = build_station_list()
    N = 9
